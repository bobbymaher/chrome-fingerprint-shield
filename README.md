...
Header & Fingerprint Shield is a browser extension built with Manifest V3 for Chromium-based browsers (Google Chrome, Brave, Microsoft Edge). It provides HTTP header customization and browser fingerprint protection against fingerprinting engines like CreepJS, FingerprintJS, and Tembrica.

---

## Key Features

### 1. Profile Switching & Dynamic Headers
...
### 2. URL Tracking Parameter Stripper (`Clean URLs`) & Referer Trimming
...
### 3. Navigator & Client Hints Spoofing
...
### 5. Web Worker & ServiceWorker Isolation
...
### 6. Sub-Pixel DOMRect, SVGRect & Audio Noise
...
### 7. Smart WebRTC Private LAN IP Scrubbing
...
### 8. Multi-Monitor, Screen Details & Peripheral Neutering
...
### 9. sendBeacon & HTML Anchor Ping Blocking
- Intercepts `navigator.sendBeacon()` to block third-party click/leave tracking beacons.
- Disables HTML `<a>` `ping` tracking attributes on anchor elements.

### 10. Anti-Font Fingerprinting & OS Alignment
